...
function getPagination() {
    ...
    function createNavButton(text, page, isDisabled) {
        ...
        // disabled 상태일 때 'disabled' 클래스 추가
    ...
    pagination.appendChild(createNavButton("이전", current_page - 1, prev_disabled));
    ...
    pagination.appendChild(createNavButton("다음", current_page + 1, next_disabled));
}
